...
void JoinRef::Serialize(Serializer &serializer) const {
	...
	serializer.WritePropertyWithDefault<bool>(208, "is_unique", is_unique, false);
	if (serializer.ShouldSerialize(6)) {
		serializer.WritePropertyWithDefault<bool>(209, "is_implicit", is_implicit, true);
	}
}
...
unique_ptr<TableRef> JoinRef::Deserialize(Deserializer &deserializer) {
	...
	deserializer.ReadPropertyWithExplicitDefault<bool>(208, "is_unique", result->is_unique, false);
	deserializer.ReadPropertyWithExplicitDefault<bool>(209, "is_implicit", result->is_implicit, true);
	return std::move(result);
}
